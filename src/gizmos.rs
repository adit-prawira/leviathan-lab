...
impl GizmosManager {
    ...
    pub fn draw(
        ...
        match *mode {
            ...
            GizmosMode::Rotate => {
                gizmos.circle(Isometry3d::new(position, Quat::from_rotation_z(0.0)), Self::LENGTH, Color::srgb(1.0, 0.2, 0.2));
                gizmos.circle(Isometry3d::new(position, Quat::from_rotation_x(FRAC_PI_2)), Self::LENGTH, Color::srgb(0.2, 1.0, 0.2));
    ...
    pub fn sync_handles(
        ...
        for (axis, color) in axes {
           ...
           commands.spawn((
                ...
                GizmosHandle { axis, target: target_entity }
