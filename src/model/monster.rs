...
impl Monster {
    ...
    pub fn default_fish() -> Self {
        ...
        monster.parts.extend([
            monster.build_body(), monster.build_head(), monster.build_tail(),
            monster.build_belly(), monster.build_dorsal_fin(), 
            monster.build_left_eye(), monster.build_right_eye()
        ]);
        monster
    }
    ...
    fn build_body(&self) -> BodyPart {
        BodyPart { 
            id: 0, 
            name: "Body".into(), 
            part_type: PartType::Capsule { radius: 0.4, half_length: 0.5 }, 
            parent_id: None,
    ...
    fn build_tail(&self) -> BodyPart {
        BodyPart {
            id: 2,
            name: "Tail".into(),
            part_type: PartType::Capsule { radius: 0.2, half_length: 0.4 },
            parent_id: Some(0),
            children: vec![],
            translation: [0.0,0.0,0.8],
            rotation: [FRAC_1_SQRT_2,0.0,0.0,FRAC_1_SQRT_2],
    ...
    fn build_dorsal_fin(&self) -> BodyPart {
        BodyPart {
            id: 4,
            name: "DorsalFin".into(),
            part_type: PartType::Sphere { radius: 0.12 },
            parent_id: Some(0),
            children: vec![],
